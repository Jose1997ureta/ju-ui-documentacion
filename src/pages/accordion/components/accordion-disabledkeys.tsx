...
export const AccordionDisabledKeys = () => {
	const { handleChangeTab, keyCurrent } = useTab();
	const [activekey, setActivekey] = useState<string[]>(["item1"]);
	const [disabledkey] = useState<string[]>(["item1", "item3"]);
	...
	return (
		<div className="mt-2" id="uso">
			<h2 className="text-2xl mt-4">Disabled Keys</h2>
...
const App = () => {
	...
	return (
		<Accordion activeKeys={activekey} multiple disabledKeys={disabledkey}>
			<Accordion.Item
				keyCurrent="item1"
				onClick={handleClick}
				title="Accordion 1"
